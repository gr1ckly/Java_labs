...
import main.classes.alive.Scooperfield;
import main.classes.alive.Sproots;
...
public class Main {
    public static void main(String[] args){
        ...
        var duck = new Animals.Duck("утка");
        ducks.addAnimal(duck);
        Scooperfiled.putOn("черный цилиндр");
        var area = new Location("площадка");
        var young_animal = new Animals.Bear("молодняк");
        var publics = new WorkingClass("Публика");
        var random_chel = new WorkingClass.Workman("чел");
        var watchman = new WorkingClass.WatchMan("Сторож");
        var fence = new Location("ограда");
        var bear = new Animals.Bear("хорошенький медвежонок");
        ...
        var flower = new FlowersClass.Flower("цветок");
        ...
        var one_of_many = new RichClass.RichMan("Один из многих");
        ...
        var richman = new RichClass.RichMan("богач");
        var workmen = new WorkingClass("Рабочие");
        var workman = new WorkingClass.Workman("рабочий");
        ...
        var one_of_some = new RichClass.RichMan("Один из некоторых");
        ...
        var one_of_another = new WorkingClass.Workman("один из других");
        var shorty = new WorkingClass.Workman("Коротышка");
        var servants = new WorkingClass("Слуги");
        var one_of_servants = new WorkingClass.Workman("один из слуг");
        servants.addWorkman(one_of_servants);
        var canteen = new Location("столовая");
        var chief = new WorkingClass.Workman("главный повар");
